  ...
  return (
    <section
      className="w-full relative flex flex-col items-center 
        justify-center px-4 md:px-0 py-8"
    >
      {/* Hero */}
      <Wrapper>
        <Container>
          ...
          >
            ...
            <div
              className="flex flex-col items-center mt-8 
                        max-w-3xl mx-auto w-11/12 md:w-full"
            >
              <h1
                className="text-4xl md:text-6xl lg:textxl md:!leading-snug 
              font-semibold text-center bg-clip-text bg-gradient-to-b
               from-gray-50 to-gray-50 text-transparent"
              >
                Build your next idea and ship your dream site
              </h1>
              <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                24/7 support , maximum speed. Make professional sites easy, fast
              ...
              <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                ...
                >
                  <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                    ✨ {"  "} Start building your dream website with us now!
                  </p>
                  <Button
                    size="sm"
      ...
      {/* How it works */}
      <Wrapper className="flex fle-col items-center justify-center py-12 relative">
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              Turn your vision into reality in just 3 single steps
            </p>
          </div>
        </Container>
        <Container>
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              SparkStudio offers a range of features to help you build a
              stunning websites in a short times
            </p>
          </div>
        </Container>
        <Container>
          <div className="flex items-center mx-auto mt-8">
            <Icons.feature className="w-full h-80" />
          </div>
        </Container>
        <Container>
          <div className="flex flex-col items-center justify-center py-10 md:py-20 w-full">
